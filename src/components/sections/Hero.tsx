    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-in-up inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 mb-8">
          ...
          <h1 className="animate-fade-in-up text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-[1.1] tracking-tight">
            Medicamentos{' '}
          ...
          <p className="animate-fade-in-up text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-12 leading-relaxed">
